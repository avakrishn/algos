...
console.log('Above Output Should be: [0,1,9,16,100]');
console.log('--------------------------------------');

console.log(sortedSquares([-7,-3,2,3,11]));
console.log('Above Output Should be: [4,9,9,49,121]');
console.log('--------------------------------------');

console.log(sortedSquares([-7,-3]));
console.log('Above Output Should be: [9,49]');
console.log('--------------------------------------');

console.log(sortedSquares([2,3,11]));
console.log('Above Output Should be: [4,9,121]');
console.log('--------------------------------------');